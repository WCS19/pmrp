"""Replay error taxonomy with safe structured context."""
...
class ReplayManifestLoadError(ReplayError):
    """A replay manifest file could not be safely loaded."""


class ReplayDatasetLoadError(ReplayError):
